...
# Images are local WebP (assets/img/<slug>-{800,1600}.webp), generated by build/convert_images.py.
# Entries are (slug, alt). generate.py builds responsive src/srcset. og is an absolute URL.
IMAGES = {
    "hero": [
    ...
    "og": "https://colonbeachrentals.xyz/assets/img/og.jpg",
    "film_poster": "balcony",
}
